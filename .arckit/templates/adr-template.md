...
> **Template Status**: Beta | **Version**: 0.11.2 | **Command**: `/arckit.adr`
...
- **Research findings**: [Link to research-findings.md section]
...
- **[Driver name]**: [Description]
  - Requirements: BR-XXX
  - Stakeholder goals: [Link to stakeholder-drivers.md]
...
**Link to risk register**: [projects/XXX/risk-register.md - Risk ID: RISK-XXX]
...
**Stakeholder drivers**: `projects/XXX/stakeholder-drivers.md`
- [Link to stakeholder goals this decision supports]

**Risk register**: `projects/XXX/risk-register.md`
- RISK-XXX: [Risk this decision mitigates]

**Research findings**: `projects/XXX/research-findings.md`
- [Section/page that analyzed these options]

**Wardley Maps**: `projects/XXX/wardley-maps/[name].md`
- [Map showing evolution stage of chosen components]

**Architecture diagrams**: `projects/XXX/diagrams/`
- [List C4/deployment/sequence diagrams showing this decision]

**Strategic roadmap**: `projects/XXX/roadmap.md`
- [Theme/initiative this decision supports]

### 9.3 Design Documents

**High-Level Design**: `projects/XXX/vendors/[vendor]/hld.md` or `projects/XXX/hld.md`
- [Section showing implementation of this decision]

**Detailed Design**: `projects/XXX/vendors/[vendor]/dld.md` or `projects/XXX/dld.md`
- [Detailed implementation specifications]

**Data model**: `projects/XXX/data-model.md`
