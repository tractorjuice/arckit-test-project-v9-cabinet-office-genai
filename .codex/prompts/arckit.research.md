...
**Read the requirements document (`ARC-*-REQ-*.md`) and extract**:
...
- Write to `projects/{project-dir}/ARC-{PROJECT_ID}-RSCH-v1.0.md`
...
**You should**:
1. Read the requirements document in `projects/001-ecommerce-platform/` (any `ARC-*-REQ-*.md` file)
...
7. Write to `projects/001-ecommerce-platform/ARC-001-RSCH-v1.0.md`
...
2. Read the requirements document in `projects/002-citizen-portal/` (any `ARC-*-REQ-*.md` file)
...
9. Write to `projects/002-citizen-portal/ARC-002-RSCH-v1.0.md`
...
- **Input**: Requires requirements document (`ARC-*-REQ-*.md`) (identifies research categories from requirements)
- **Input**: Uses data model (`ARC-*-DATA-*.md`) (understands data entities for database research)
- **Input**: Uses stakeholder analysis (`ARC-*-STKE-*.md`) (prioritises research based on stakeholder needs)
...
**Use the Write tool** to create `projects/[PROJECT]/ARC-{PROJECT_ID}-RSCH-v1.0.md` with the complete research document.
...
**File Created**: `projects/[PROJECT]/ARC-{PROJECT_ID}-RSCH-v1.0.md`
...
- Review `ARC-{PROJECT_ID}-RSCH-v1.0.md` for detailed findings
