...
7. **Write outputs**:
   - `projects/{project-dir}/ARC-{PROJECT_ID}-TRAC-v1.0.md` - Full traceability matrix
   - `projects/{project-dir}/ARC-{PROJECT_ID}-COVR-v1.0.md` - Coverage metrics and gaps
   - `projects/{project-dir}/ARC-{PROJECT_ID}-GAPS-v1.0.md` - Detailed gap analysis with remediation plan
